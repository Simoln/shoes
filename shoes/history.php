...
<body onload="showStars()">
  ...
  <!-- Gallery -->
  <!-- Menu -->
  <div class="py-5 text-center" id="menu" style="background-image: url(&quot;image/four2.png&quot;);">
    <div class="container">
      <div class="row p-4 my-5 bg-primary animate-in-down">
        <div class="col-md-12">
          <h2 class="mt-3">三双鞋 <br>Three pairs of shoes</h2>
          <p class="mb-5"><a href="home2.php">第一期</a></p>
          <div class="row">
            <div class="col-md-4 p-3">
              <img class="img-fluid d-block w-100 mb-3" src="<?php echo $image4; ?>">
              <p class="lead text-muted mb-1"><?php echo $name4; ?></p>
              <h5 class="text-dark">
                <b></b>
              </h5>
              <p class="mb-3">
              </p>
              <div>推荐指数： <div class="demo" data-scroe="<?php echo $level4; ?>">
                  <div class="yellowstar"></div>
                </div>
              </div>
              <p></p>
              <div class="col-md-12 p-4">
                <h2 class="mb-4"><?php echo $price4; ?></h2>
                <p><?php echo $brand4; ?> <br>
                </p>
              </div>
            </div>
            <div class="col-md-4 p-3">
              <img class="img-fluid d-block w-100 mb-3" src="<?php echo $image5; ?>">
              <p class="lead text-muted mb-1"><?php echo $name5; ?></p>
              <h5 class="text-dark">
                <b></b>
              </h5>
              <p class="mb-3">
              </p>
              <div>推荐指数： <div class="demo" data-scroe="<?php echo $level5; ?>">
                  <div class="yellowstar"></div>
                </div>
              </div>
              <p></p>
              <div class="col-md-12 p-4">
                <h2 class="mb-4"><?php echo $price5; ?></h2>
                <p> <?php echo $brand5; ?> <br>
                </p>
              </div>
            </div>
            <div class="col-md-4 p-3">
              <img class="img-fluid d-block w-100 mb-3" src="<?php echo $image6; ?>">
              <p class="lead text-muted mb-1"><?php echo $name6; ?> </p>
              <h5 class="text-dark">
                <b></b>
              </h5>
              <p class="mb-3">
              </p>
              <div>推荐指数： <div class="demo" data-scroe="<?php echo $level6; ?>">
                  <div class="yellowstar"></div>
                </div>
              </div>
              <p></p>
              <div class="col-md-12 p-4">
                <h2 class="mb-4"><?php echo $price6; ?></h2>
                <p><?php echo $brand6; ?><br></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row p-4 my-5 bg-primary animate-in-down">
        <div class="col-md-12">
          <h2 class="mt-3">三双鞋 <br>Three pairs of shoes</h2>
          <p class="mb-5"><a href="home1.html">第二期</a></p>
          <div class="row">
            <div class="col-md-4 p-3">
              <img class="img-fluid d-block w-100 mb-3" src="<?php echo $image1; ?>">
              <p class="lead text-muted mb-1"><?php echo $name1; ?></p>
              <h5 class="text-dark">
                <b></b>
              </h5>
              <p class="mb-3">
