    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" >
          <div class="carousel-item active">
            ...
            <br>
            <br>
            <img class="d-block img-fluid mx-auto" src="<?php echo $logo3; ?>" data-holder-rendered="true" width="300">
      ...
      <div class="row">
        <div class="col-md-4 p-4">
          ...
          <p class="m-0">
              <p class="mb-3">
                  <div class="demo" data-scroe="<?php echo $view3; ?>">
        ...
        <div class="col-md-4 p-4">
          <h2 class="mb-4">穿搭：</h2>
          <p class="mb-3">
              <div class="demo" data-scroe="<?php echo $wear3; ?>">
                      <div class="yellowstar"></div>
                  </div>
          </p>
        </div>
        <div class="col-md-4 p-4">
          <h2 class="mb-4">实战：</h2>
          <p class="mb-3">
              <div class="demo" data-scroe="<?php echo $fight3; ?>">
                      <div class="yellowstar"></div>
                  </div>
          </p>
        </div>     
      ...
      <div style="text-align: center;">
            <i  class="fa fa-star d-inline"><a href="<?php echo $offical3; ?>">官网地址</a></i>
            <i class="fa fa-star mx-1 d-inline"><a href="<?php echo $taobao3; ?>">淘宝链接</a></i>
            <i class="fa fa-star mx-1 d-inline"><a href="<?php echo $bili3; ?>">B站评测</a></i></div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="p-0 col-md-6">
              <div class="carousel slide" data-ride="carousel" id="carousel1">
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                    <img class="d-block img-fluid w-100" src="<?php echo $url31; ?>" atl="first slide">
                    <div class="carousel-caption">
                        <h3><?php echo $des31; ?></h3>
                      </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block img-fluid w-100" src="<?php echo $url32; ?>" data-holder-rendered="true">
                    <div class="carousel-caption">
                      <h3><?php echo $des32; ?></h3>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block img-fluid w-100" src="<?php echo $url33; ?>" data-holder-rendered="true">
                    <div class="carousel-caption">
                      <h3><?php echo $des33; ?></h3>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block img-fluid w-100" src="<?php echo $url34; ?>" data-holder-rendered="true">
                    <div class="carousel-caption">
                      <h3><?php echo $des34; ?></h3>
                    </div>
                  </div>
                </div>
