                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4 p-3">
                                ...
                                <p class="mb-3">
                                    <div>推荐指数：
                                    <div class="demo" data-scroe="<?php echo $level1; ?>">
                                            <div class="yellowstar"></div>
                                        </div></div>
                                </p>
                                <a href="shoes1.php" class="btn btn-outline-secondary">
                                    <b class="">MORE</b>
                                    <b class=""></b>
                                </a>
                            ...
                            <div class="col-md-4 p-3">
                                ...
                                <p class="mb-3">
                                        <div>推荐指数：
                                        <div class="demo" data-scroe="<?php echo $level2; ?>">
                                                <div class="yellowstar"></div>
                                            </div></div>
                                    </p>
                                <a href="shoes2.php" class="btn btn-outline-secondary">
                                    <b class="">MORE</b>
                                </a>
                                <div class="col-md-12 p-4">
                            ...
                            <div class="col-md-4 p-3">
                                ...
                                <p class="mb-3">
                                        <div>推荐指数：
                                        <div class="demo" data-scroe="<?php echo $level3; ?>">
                                                <div class="yellowstar"></div>
                                            </div></div>
                                    </p>
                                <a href="shoes3.php" class="btn btn-outline-secondary">
                                    <b class="">MORE</b>
                                </a>
                                <div class="col-md-12 p-4">
